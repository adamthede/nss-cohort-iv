...
test('Client#delPortfolio', function() {
  ...
  var testPorts = c2.delPortfolio(['Pig Stocks','Illegal Guns']);
  ...
  deepEqual(testPorts[0].name, 'Pig Stocks', 'first deleted portfolio gotten from c2 should have name Illegal Guns');
  deepEqual(testPorts[1].name, 'Illegal Guns', 'second deleted portfolio gotten from c2 should have name Pig Stocks');
});
